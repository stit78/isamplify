class Sample < ApplicationRecord
  ...
  validates :sweetness, inclusion: { in: [0, 1, 2, 3, 4, 5] }, allow_blank: true
  validates :acidity, inclusion: { in: [0, 1, 2, 3, 4, 5] }, allow_blank: true
  validates :clean, inclusion: { in: [0, 1, 2, 3, 4, 5] }, allow_blank: true
